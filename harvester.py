...
def harvest_regional_feeds():
    ...
    Spaced out with a short delay between requests — firing all 10 at once
    from the same runner IP is what triggers Google News rate-limiting."""
    ...
    for lang, url in REGIONAL_LANG_FEEDS.items():
        ...
        push_to_worker(f'/api/update-regional-feed?lang={lang}', payload, f'regional [{lang}]')
