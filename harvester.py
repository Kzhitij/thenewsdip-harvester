...
FEED_SOURCES = {
    ...
    'business': [
        ...
        ('CNBCTV18',         'https://www.cnbctv18.com/commonfeeds/v1/eng/rss/economy.xml'),
        ('Bloomberg India',  'https://news.google.com/rss/search?q=India+economy+markets&hl=en-IN&gl=IN&ceid=IN:en'),
        ('Reuters Business', 'https://feeds.reuters.com/reuters/businessNews'),
    ],
    'sports': [
        ('ESPNcricinfo',  'https://www.espncricinfo.com/rss/content/story/feeds/0.xml'),
        ('NDTV Sports',   'https://feeds.feedburner.com/ndtv/sports'),
        ('Sportskeeda',   'https://www.sportskeeda.com/feed'),
        ('CricBuzz',      'https://news.google.com/rss/search?q=cricket+IPL+India&hl=en-IN&gl=IN&ceid=IN:en'),
    ...
    'tech': [
        ...
        ('NDTV Gadgets',  'https://feeds.feedburner.com/ndtv/gadgets'),
    ...
    'entertainment': [
        ...
        ('Filmfare',          'https://www.filmfare.com/news/rss.xml'),
        ('Hollywood Reporter','https://www.hollywoodreporter.com/feed/'),
        ('Variety',           'https://variety.com/feed/'),
        ('NDTV Movies',       'https://feeds.feedburner.com/ndtv/entertainment'),
    ],
}
...
def fetch_feed(source_name, url, feed_cat, cutoff_time, seen_urls):
    ...
    try:
        ...
        for item in items:
            ...
            pub_el   = item.find('pubDate') or item.find('dc:date') or item.find('{http://purl.org/dc/elements/1.1/}date')
